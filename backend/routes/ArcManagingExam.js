...
const ArcManagingExam = express.Router();

ArcManagingExam.post('/api/exam', AdminAuth('exam timetable'), async (req, res) => {
...
ArcManagingExam.post('/api/exam-subject/:id', AdminAuth('exam timetable'), async (req, res) => {
...
// ArcManagingExam.get('/mobileAPI/exam-time-table',async (req,res)=>{
//     try{
...
ArcManagingExam.get('/mobileAPI/exam-time-table',completeLogin, async (req, res) => {
    try {
...
ArcManagingExam.put('/api/exam/:id', AdminAuth('exam timetable'), async (req, res) => {
    const exam_id = req.params.id;
    const { exam_name, start_date, end_date, standard, section } = req.body;
...
ArcManagingExam.delete('/api/exam/:id', AdminAuth('exam timetable'), async (req, res) => {
    const exam_id = req.params.id;
...
ArcManagingExam.put('/api/exam-subject/:id', AdminAuth('exam timetable'), async (req, res) => {
...
ArcManagingExam.delete('/api/exam-subject/:id', AdminAuth('exam timetable'), async (req, res) => {
    const examSubject_id = req.params.id;
...
export default ArcManagingExam;
